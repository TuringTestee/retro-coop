...
test('directory search preserves distinct same-name rooms and supports names or exact normalized codes',()=>{
 const rooms:RoomPreview[]=[{id:'one',label:'Arcade',host:'Jade',visibility:'public',code:'ABCDEFGH',status:'waiting',occupancy:1,guestPlace:'open',guestPlaceVersion:0},{id:'two',label:'Arcade',host:'Coral',visibility:'public',code:'BCDEFGHJ',status:'reserved',occupancy:2,guestPlace:'open',guestPlaceVersion:0}];
