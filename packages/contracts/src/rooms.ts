...
export type RoomView = HumanRoomPreview & { game?:GameView; hostReady?:boolean; guestAcquisition?:'checking'|'downloading'|'loading'|'loaded'|'failed'; started?:'solo'|'shared'; established?:boolean; guestReconnectUntil?:number; chatMembership:string; invite:string; role:RoomRole; slot:1|2; connectionPolicy:ConnectionPolicy; peer:PeerView; guest?:string; guestMembership?:string; reservationUntil?:number; reservationIntent?:string; fingerprint:Fingerprint; matches?:boolean; hostReconnectUntil?:number };
