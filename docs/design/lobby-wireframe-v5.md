...
# Lobby wireframe v5: corrected transfer states

**Current sketch:** Revises [v4](lobby-wireframe-v4.md) after its [critique](lobby-critique-v4.md). Approved behavior remains [room game downloads](room-rom-transfer.md); unaffected pages remain in [v3](lobby-wireframe-v3.md).
...
Downloading game… 1.4 / 2.1 MB                      [Cancel preparation]
