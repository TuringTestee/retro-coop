...
| RT3 | Membership-scoped download and shared verified cache | Guest Join fetches exact bytes, caches/reuses them, detects corrupt/partial data, and handles quota fallback. Depends on RT1; reuse existing catalog acquisition. |
