...
- Complete preflight at evidence commit `3fbceee` passed in 7.92 seconds with all 22 native tests and all Node checks; no skipped tests. [Raw preflight](preflight.txt). The merge-base committed diff check also passed.
- WASM SHA-256: `5f0b24f626e00f4dba4c4a7cbe08c7b19e514b8d9631a7f81c45f0cd6777efaa`; complete browser workload: 47.52 seconds.
