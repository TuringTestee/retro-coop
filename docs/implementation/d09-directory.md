...
- Existing room lifecycle and foundation/settings/battery browser suites remain regression gates. CI adds the short directory probe to the existing core job under the shared 30-minute deadline; preflight remains bounded by 60 seconds.
