...
with tempfile.TemporaryDirectory(prefix='retro-versioned-core-') as directory:
    ...
    for relative in ['apps/client/src/worker.ts', 'apps/client/vite.config.ts']:
        (scratch / relative).write_bytes(subprocess.check_output(['git', 'show', '2f58a1e915d3849c5732677bc77e9b52a8f41f7b:' + relative], cwd=root))
    shutil.copyfile(scratch / 'apps/client/src/generated/retro_coop_d02.wasm', scratch / 'apps/client/public/generated/retro_coop_d02.wasm')
    source = scratch / 'apps/client/public/generated/retro_coop_d02.wasm'
    ...
    for index, wasm in enumerate([original, original + b'\x00\x05\x04d24b']):
        ...
        assets = [output / 'generated/retro_coop_d02.wasm']
        assert len(assets) == 1
    ...
    def publish(release):
        shutil.copyfile(release / 'generated/retro_coop_d02.wasm', site / 'generated/retro_coop_d02.wasm')
