...
| D22 | P0: control spend | Capacity and monitored cost envelope — delivery hosting; design operations | Scoped relay credentials/quotas, measured load/session-hours/cost, $50/$100 billing alerts, admission behavior, shutdown rehearsal and operational telemetry; record residual variable-charge risk. AC-01 load, AC-10/11. | D18, D19, D24 |
