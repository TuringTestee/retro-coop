...
The approved [room game transfer plan](room-rom-transfer.md) and its [human behavior](../design/room-rom-transfer.md) supersede the original no-upload/guest-matching-file architecture for custom rooms. Issues #87–#91 track implementation; current runtime support remains the older local-file path until they integrate. All other delivery and verification rules continue to apply.
