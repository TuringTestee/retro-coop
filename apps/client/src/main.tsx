...
function App() {
 ...
 return <main className={`${showDiscovery?'discovery':showRoom?'waiting-room':'playing'}${browsing?' browsing':''}${state.shared?' shared-session':''}${sessionOpen?' session-open':''}`} data-coordinator={clientConfig.coordinatorUrl}>
