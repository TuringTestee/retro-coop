...
if [ "$D02_JOB" = entrypoint ]; then
  ...
  timeout --foreground 65s python3 scripts/rooms/two_agent_game.py --role run --rom apps/client/dist/generated/diagnostic.nes --session-dir spikes/d02/public-entrypoint.local/two-agent-game
  exit
fi
