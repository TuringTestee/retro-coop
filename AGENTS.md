...
- Put journeys and behavior in `docs/design/` and technical plans in `docs/implementation/`. Start human-facing documents with a short plain-English summary.
...
- Use `project-orchestrator` for dependencies and `pr-draft-review` for tests and evidence. Substantive PRs need independent review in a separate detached worktree. Follow the [handoff contract](tooling/vaseline/docs/agent/review-handoff.md).
