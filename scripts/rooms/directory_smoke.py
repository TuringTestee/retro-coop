...
try:
    ...
    with sync_playwright() as p:
        ...
        observer.get_by_label('Search rooms, hosts or public code').fill('')
        ...
        offline.wait_for_function("document.querySelector('.room-list button')?.disabled===false")
