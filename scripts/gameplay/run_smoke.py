...
cases=[('delayed-join',['--delay-join']),('operator-remove',['--operator-playing','remove']),('operator-block',['--operator-playing','block']),('kick-playing',['--kick-playing']),('shared',['--screenshots']),('relay',['--relay']),('late-join-denied',['--late-join']),('cancel',['--cancel-barrier']),('ack-timeout',['--barrier-timeout']),('retry-guest-first',['--retry-barrier','guest-first']),('retry-host-first',['--retry-barrier','host-first']),('delayed-start',['--delay-start'])]
